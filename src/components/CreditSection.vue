...
<template>
    <div class="comic-socials mt-8 grid grid-cols-2 gap-3">
        <div class="col-span-2 hidden md:block">
            <div class="p-2 py-3 h-16 bg-gray-50 ring-1 ring-gray-500/10 ring-inset rounded-lg flex items-center">
                <div class="divider mx-2 w-1 h-full rounded-full bg-gray-200 ring-1 ring-gray-500/10 ring-inset">
                </div>
            ...
            <div
                ...
                <button class="px-4 py-2 bg-red-400 rounded-full text-white flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                        fill="currentColor" class="icon icon-tabler icons-tabler-filled icon-tabler-alert-hexagon">
